...
/****************** PRINT POINTER ******************/
/**
 * print_pointer - Print the value of pointer variables
 ...
 * Return:ThenNumber of chars printed.
 */
...
/************************* PRINT NON PRINTABLE *************************/
/**
 * print_non_printable - Prints all  ascii codes in hexa of non printable chars
...
/************************* PRINT REVERSE *************************/
/**
 * print_reverse - Prints all reverse string.
 * @types: List a of arguments
 * @buffer: Buffer arrays to handle the  print
 * @flags:  Calculates the active flags
 * @width: get widths
